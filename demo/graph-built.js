...
(function() {
  exports.formatArray = function(array) {
    var i, n, res, y, _i, _len;
    n = array.length;
    res = new Array(n);
  ...
  exports.createBuffer = function(n, generator) {
    var i, res, _i;
    res = new Buffer(n * 2);
    for (i = _i = 0; 0 <= n ? _i < n : _i > n; i = 0 <= n ? ++_i : --_i) {
...
// Generated by CoffeeScript 1.7.1
(function() {
  var bufferToArray, createBuffer, data1, data2, formatArray, graph, newLength, originalLength, resample, _ref;

  resample = require('./resample');

  _ref = require('./common'), bufferToArray = _ref.bufferToArray, createBuffer = _ref.createBuffer, formatArray = _ref.formatArray;

  originalLength = 100;

  newLength = 117;

  data1 = createBuffer(originalLength, function(i) {
    return Math.sqrt(i) + Math.cos(i * Math.PI / 20) | 0;
  });
...
},{"./common":4,"./resample":6}],6:[function(require,module,exports){
(function (Buffer){
// Generated by CoffeeScript 1.7.1
(function() {
